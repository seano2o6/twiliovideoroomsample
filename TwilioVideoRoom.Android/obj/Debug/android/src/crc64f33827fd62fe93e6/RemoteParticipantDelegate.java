package crc64f33827fd62fe93e6;


public class RemoteParticipantDelegate
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Twilio.Video.Participant.Delegates.RemoteParticipantDelegate, Twilio.Video", RemoteParticipantDelegate.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == RemoteParticipantDelegate.class)
			mono.android.TypeManager.Activate ("Twilio.Video.Participant.Delegates.RemoteParticipantDelegate, Twilio.Video", "", this, new java.lang.Object[] {  });
	}
